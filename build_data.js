...
const charactersDir = path.join(__dirname, 'characters', 'data');
const eventsDir = path.join(__dirname, 'characters', 'events');
...
window.eventsData = ${JSON.stringify(eventsData, null, 4)};
`;
